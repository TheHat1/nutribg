        ...
        <>
            <div className="w-screen h-screen flex justify-center pt-40">
                <div className="bg-white w-[90vw] max-w-200 min-h-100 h-fit rounded-lg flex items-center p-10 flex-col space-y-3">
                    ...
                    <h1 className=" text-xl font-display font-bold">Имаш профил? Влез в него <a onClick={() => { navigate('/login') }} className="text-lime-600 cursor-pointer hover:brightness-125 transition-all ">тук</a>.</h1>
